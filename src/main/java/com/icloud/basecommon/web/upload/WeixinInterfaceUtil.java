...
//
//             String userSubcribeInfoUrl = .get("get_userinfo_by_baseaccesstoken").replace("ACCESS_TOKEN",accessToken).replace("OPENID",openid);
...
//        }
        ...
        private  String downloadWeixinFiles(String mediaId,String basePath,String savePath,int count){
            ...
            String requestUrl = "";//get_media_info.get("get_media_info");
        ...
        public  JSONArray getImageUrlByMedias(JSONArray jsonArray, String basePath,
            ...
            String requestUrl = WxConst.USER_INFO_BASE;//？？？？？？
            String accessToken = null;
            log.info("get_media_info====="+requestUrl);
            log.info("accessToken====="+accessToken);
