...
//            int width = Integer.parseInt(.get("app_qrcode_width"));
//            boolean autoColor = Boolean.parseBoolean(.get("app_qrcode_auto_color"));
//            Map<String, Object> params = new HashMap<String, Object>();
//            params.put("scene", id);
//            params.put("width", width);
//            params.put("auto_color", autoColor);
//            if (!autoColor) {        //autoColor为false，读取配置文件的line_color并添加参数
//                String line_color = .get("app_qrcode_line_color");
...
//            String ftpPath = .get("filepath") + Contants.IMG_BASE_PATH_;
