...
//		/*1、先从缓存取*/
//        Object obj = redisService.get(.get("hostnumber"));
...
//			}else{
//				// 如果请求成功
//                String requestUrl = .get("get_baseaccess_token_url").replace("APPID", .get("appid")).replace("APPSECRET",  .get("appsecret"));
...
//                        //存入缓存
//                        redisService.set(.get("hostnumber"),accessToken);
//                        return accessToken;
//                    } catch (Exception e) {
//                        accessToken = null;
//                        //刷新token失败
...
//	    String sign = MD5Utils.encode2hex(.get("appid")+randomStr+.get("get_basetoken_key"));
//	    String param ="?appid="+.get("appid")+"&randomStr="+ randomStr+"&sign="+sign;
//        String url = .get("get_basetoken_url")+param;
